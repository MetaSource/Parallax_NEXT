...
const Navbar = ({brand}) => {
  return (
    ...
    <div className='fixed left-0 top-0 w-full z-10 easin-in duration-300'>
        <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
            <Link href='/'>
            <h1 className='font-bold text-4xl'>{brand}</h1>
            </Link>
            ...
            <div className='sm:hidden absolute top-0 right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300'>
                <ul>
